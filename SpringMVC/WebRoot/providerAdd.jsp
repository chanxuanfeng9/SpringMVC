...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/provider/addProvider">
		<input type="hidden" name="method" value="add">
		<div class="content">
			<table class="box">
			   <tbody><tr>
					<td class="field">供应商名称：</td>
					<td><input type="text" name="proName" class="text" id="proName" value="${provider.proName}"> <font color="red">*</font><font color="red" id="proName_span"></font></td>
				</tr>
				 <tr>
