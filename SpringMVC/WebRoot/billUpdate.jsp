...
<div class="main">
	...
	<f:form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/bill/updateBill">
...
<%-- <script type="text/javascript" src="${pageContext.request.contextPath}/js/bill/update.js"></script> --%>
